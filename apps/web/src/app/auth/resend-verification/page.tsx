        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm mb-5">If an unverified account exists for {email}, a new verification link was sent.</p>
              <Link href="/auth/login" className="text-primary hover:underline text-sm font-medium">Back to sign in</Link>
            </div>
          ) : (
            <>
              <h2 className="text-xl font-bold text-gray-900 mb-1">Resend verification email</h2>
              <p className="text-gray-500 text-sm mb-5">Enter your email and we&apos;ll send a new verification link.</p>
