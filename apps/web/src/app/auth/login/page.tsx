    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium"
        >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href={inviteToken ? `/auth/register?invite=${inviteToken}` : "/auth/register"} className="text-primary font-medium hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  );
